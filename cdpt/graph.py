...
class Word:
    ...
    def __init__(self, word, upos, lemma=None, xpos=None, feats=None, deps=None, misc=None):
        self.word = word
        ...
        #  self.feats_dic = parse_dict(self.feats)
        self.deps = deps if deps else "_"
        self.misc = misc if misc else "_"
        #  self.misc_dic = parse_dict(self.misc)

    def cleaned(self):
        return Word(self.word, "_")

    def clone(self):
        return Word(self.word, self.upos, self.lemma, self.xpos, self.feats, self.deps, self.misc)
